      ...
      <PageContainer maxWidth="md">
        <Box sx={{ mb: 4 }}>
          ...
          <Typography variant="body1" color="text.secondary" sx={{ lineHeight: 1.8 }}>
            えんまーるは、長崎市内の保育士と保育園をつなぐスポットマッチングプラットフォームです。
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, mb: 4 }}>
          {[
            { step: 1, title: '登録', body: 'メールアドレスとパスワードで無料登録。保育士・保育園のどちらか選択してください。' },
            { step: 2, title: 'プロフィール設定', body: '保育士は希望条件・経験を、保育園はコンセプト・募集内容を入力します。' },
            { step: 3, title: '応募・マッチング', body: '保育士が気になる募集に応募。管理者が確認しマッチング成立のお知らせをします。' },
            { step: 4, title: '業務実施', body: 'マッチング成立後、保育園と詳細調整。当日は安心して業務に取り組めます。' },
            { step: 5, title: '評価', body: '業務完了後、双方が評価を記入。次のマッチングに活かせます。' },
          ].map((item) => (
            <Box
              key={item.step}
              sx={{
